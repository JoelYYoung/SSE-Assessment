...
def main(argv):
    ...
    for diff_name in diff_name_list:
        ...
        one_result_str += subprocess.run("python sse-assessment.py {0}{1}.sse.db {0}{1}.ikos.db {0}{1}.sarif".format(diff_dir_path, diff_name), capture_output=True, text=True).stdout
